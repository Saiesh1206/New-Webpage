...
lottie_animation = load_lottie_file("/Users/saieshchikne/Downloads/Animation.json")

# Set page configuration
st.set_page_config(page_title="Saiesh Chikne", page_icon=":man_student:", layout="wide")
...
st.header("Contact")
st.write("You can reach me via [email](mailto:saieshchikne@gmail.com) or connect with me on [LinkedIn](https://www.linkedin.com/in/sai%C3%A9sh-chikn%C3%A9-0b3092261/).")
